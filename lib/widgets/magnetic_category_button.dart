      ...
      child: AnimatedBuilder(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(color: widget.color.withOpacity(.2), width: 1.5),
            boxShadow: <BoxShadow>[
              BoxShadow(color: widget.color.withOpacity(.20), offset: const Offset(0, 11), blurRadius: 18, spreadRadius: -7),
            ],
          ),
          child: Column(
