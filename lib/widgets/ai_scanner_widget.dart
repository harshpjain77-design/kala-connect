...
class _ReticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final corners = <Offset>[Offset(inset, inset), Offset(size.width - inset, inset), Offset(inset, size.height - inset), Offset(size.width - inset, size.height - inset)];
    ...
    paint.color = KalaColors.turmeric.withOpacity(.48);
