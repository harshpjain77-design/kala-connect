  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: <Color>[option.color.withOpacity(.90), option.color.withOpacity(.62)]),
            boxShadow: <BoxShadow>[BoxShadow(color: option.color.withOpacity(.35), offset: const Offset(0, 12), blurRadius: 22)],
          ),
