    ...
    return Transform.translate(
      ...
      child: Transform(
        ...
        child: Container(
          height: 240,
          width: 240,
          decoration: BoxDecoration(shape: BoxShape.circle, gradient: const RadialGradient(colors: <Color>[Color(0xFFFFE291), KalaColors.terracotta, Color(0xFF672345)]), boxShadow: <BoxShadow>[BoxShadow(color: KalaColors.terracotta.withOpacity(.42), blurRadius: 45, spreadRadius: 7)]),
