...
class _ProductPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          height: 126,
          decoration: BoxDecoration(color: Colors.white.withOpacity(.78), borderRadius: BorderRadius.circular(25), boxShadow: const <BoxShadow>[BoxShadow(color: Color(0x14543A1C), blurRadius: 18, offset: Offset(0, 8))]),
          child: Row(
            children: <Widget>[
              ClipRRect(
