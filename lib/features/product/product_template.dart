...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _InkPanel(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
          ...
          Wrap(spacing: 7, runSpacing: 7, children: tags.map((tag) => Chip(label: Text(tag), side: BorderSide.none, backgroundColor: KalaColors.turmeric.withOpacity(.28))).toList()),
        ]),
      );
}
...
class _InkPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(color: Colors.white.withOpacity(.76), borderRadius: BorderRadius.circular(27), boxShadow: const <BoxShadow>[BoxShadow(color: Color(0x15533C20), offset: Offset(0, 10), blurRadius: 20)]),
        child: child,
      );
}
